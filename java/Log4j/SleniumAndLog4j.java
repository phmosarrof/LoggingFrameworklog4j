...
import Log4j.loggingFramework;

public class SleniumAndLog4j {

	private static Logger log = LogManager.getLogger(SleniumAndLog4j.class.getName());

	public static void main(String[] args) {

		log.debug("Configuire chrome driver property");
		...
		a.moveToElement(driver.findElement(By.xpath("//*[@id='twotabsearchtextbox']"))).click().keyDown(Keys.SHIFT)
				.sendKeys("capitalletters").doubleClick().build().perform();
